// Chapter 8 - Programming Challenge 8, Stats Class and Rainfall Statistics
// This program uses a Stats class to store monthly rainfall data
// and to report rainfall statistics.
#include <iostream>
#include <iomanip>
#include <string>
using namespace std;
...
void rainReport(const Stats &rainfall)
{
	...
	cout << "The least rainfall fell in " << lowMonth << " with "
	     <<  rainfall.lowest() << " inches. \n";
	cout << "The most rainfall fell in " << highMonth << " with "
